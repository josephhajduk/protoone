...
var animation_ryu_kickspin = new Animation("ryu_spinnthing",simple_tdata(16,75),sheet_ryu_spinnthing)
var animation_ryu_roll_forward = new Animation("ryu_roll_forward",simple_tdata(9,75),sheet_ryu_roll)
...
var animation_ryu_forward = new Animation("ryu_forward",simple_tdata(11,40),sheet_ryu_forward)
var animation_ryu_backward = new Animation("ryu_backward",simple_tdata(11,40),sheet_ryu_backward)
...
var animation_ryu_crouching = new Animation("ryu_crouch",simple_tdata(4,100),sheet_ryu_crouching)
...
var animation_ryu_back_hk = new Animation("ryu_back_hkick",simple_tdata(13,50),sheet_ryu_back_hk)
var animation_ryu_hk = new Animation("ryu_heavy_kick",simple_tdata(13,50),sheet_ryu_heavy_kick)
var animation_ryu_mk = new Animation("ryu_medium_kick",simple_tdata(6,50),sheet_ryu_medium_kick)
var animation_ryu_lk = new Animation("ryu_light_kick",simple_tdata(7,50),sheet_ryu_light_kick)
var animation_ryu_crouch_hk = new Animation("ryu_crouch_hkick",simple_tdata(10,80),sheet_ryu_crouching_hk)
var animation_ryu_crouch_mk = new Animation("ryu_crouch_mkick",simple_tdata(6,70),sheet_ryu_crouching_mk)
var animation_ryu_crouch_lk = new Animation("ryu_crouch_light_kick",simple_tdata(6,60),sheet_ryu_crouching_lk)
var animation_ryu_hp = new Animation("ryu_heavy_punch",simple_tdata(10,50),sheet_ryu_heavy_punch)
var animation_ryu_mp = new Animation("ryu_medium_punch",simple_tdata(8,50),sheet_ryu_medium_punch)
var animation_ryu_lp = new Animation("ryu_light_punch",simple_tdata(4,50),sheet_ryu_light_punch)
